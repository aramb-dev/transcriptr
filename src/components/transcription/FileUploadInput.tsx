...
import { expandCenter, springTransition, smoothLayoutTransition } from '../../lib/animations';
  ...
  return (
    <LayoutGroup id="file-upload-container">
      <div className="mt-6 flex flex-col items-center gap-4">
        <motion.div
          className={`w-full border-2 border-dashed ${isDragging ?
            'border-blue-500 dark:border-blue-400 bg-blue-50 dark:bg-blue-900/20' :
            'border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50'}
            rounded-xl p-8 transition-all cursor-pointer`}
            ...
            <AnimatePresence mode="wait" initial={false}>
                ...
                >
                  <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30">
                    <UploadCloud
                      className={`h-8 w-8 ${
                        isDragging
                          ? 'text-blue-500 dark:text-blue-300 scale-110 transition-transform duration-200'
              ...
              {fileName && !fileError && (
                ...
                >
                  ...
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{formatFileSize(fileSize || 0)}</p>
                  <Button
                    variant="ghost"
                    size="sm"
              ...
              {fileError && (
                ...
                >
                  ...
                  <h3 className="mt-2 text-lg font-semibold text-red-500 dark:text-red-400">Error</h3>
                  <p className="mt-1 text-sm text-red-500 dark:text-red-400">{fileError}</p>
                  <Button
                    variant="ghost"
                    size="sm"
        ...
        >
          <Button
            ...
            variant="ghost"
            size="lg"
            className="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg px-6 py-8 w-full"
