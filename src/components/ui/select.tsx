...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        "pointer-events-none -mx-1 my-1 h-px bg-gray-200 dark:bg-gray-600",
        className,
      )}
      {...props}
    />
