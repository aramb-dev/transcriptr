  ...
  return (
    <html lang="en">
      <body className="font-sans">
        ...
        <Script async src="https://fundingchoicesmessages.google.com/i/pub-YOUR_PUBLISHER_ID?ers=1" nonce="YOUR_NONCE" strategy="afterInteractive" />
        ...
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-PZJLV82QQ6" strategy="lazyOnload" />
      </body>
    </html>
  )
}